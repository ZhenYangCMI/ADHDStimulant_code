...
subListFile='/home/data/Projects/Zhen/ADHDStimulant/data/subList16subRmdMotionOutliers.txt';
...
for j=1:length(covTypeList)
    ...
    destinationDir=['/home/data/Projects/Zhen/ADHDStimulant/results/CPAC_zy', processDate, '_reorganized/', covType, '/', med, '/'];
    ...
    for i=1:numSub
        ...
        subDir=['/home/data/Projects/Zhen/ADHDStimulant/results/output/pipeline_zy', processDate, '/', sub, med];
        ...
        % name
        fun2anatAffine=['/home/data/Projects/Zhen/ADHDStimulant/results/working/resting_preproc_', sub, med, '/_scan_', funImgName, '/fsl_reg_2_itk_0/affine.txt'];
        ...
        meanFun=[subDir, '/mean_functional_in_mni/_scan_', funImgName, '/lfo_calc_tshift_resample_volreg_calc_tstat_wimt.nii.gz']; % mean funImg in MNI
        standFunMask=[subDir, '/functional_brain_mask_to_standard/_scan_', funImgName, '/lfo_calc_tshift_resample_volreg_mask_wimt.nii.gz'];
